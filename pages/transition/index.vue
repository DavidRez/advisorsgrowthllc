...
import CustomTransitionHelp from '~/components/custom/custom-transition-help/custom-transition-help'
...
export default {
  components: {
    ...
    BlockStackedLinks,
    BlockText,
    CustomTransitionHelp
  },
  async asyncData () {
    const data = await setData('transition')
    return { props: data }
  },
  head () {
